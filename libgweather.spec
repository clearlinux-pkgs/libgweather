...
Source0  : https://download.gnome.org/sources/libgweather/3.28/libgweather-3.28.2.tar.xz
Summary  : No detailed summary available
Group    : Development/Tools
License  : GPL-2.0
Requires: libgweather-data
Requires: libgweather-lib
Requires: libgweather-license
...
export LANG=C
export SOURCE_DATE_EPOCH=1528907142
...
%install
mkdir -p %{buildroot}/usr/share/doc/libgweather
cp COPYING %{buildroot}/usr/share/doc/libgweather/COPYING
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/libgweather/COPYING
