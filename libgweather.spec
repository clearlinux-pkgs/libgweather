...
Source0  : https://download.gnome.org/sources/libgweather/3.36/libgweather-3.36.0.tar.xz
...
%prep
%setup -q -n libgweather-3.36.0
cd %{_builddir}/libgweather-3.36.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585173256
...
cp %{_builddir}/libgweather-3.36.0/COPYING %{buildroot}/usr/share/package-licenses/libgweather/4cc77b90af91e615a64ae04893fdffa7939db84c
