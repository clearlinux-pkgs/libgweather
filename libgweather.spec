...
%prep
%setup -q -n libgweather-40.0
cd %{_builddir}/libgweather-40.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619121496
...
cp %{_builddir}/libgweather-40.0/COPYING %{buildroot}/usr/share/package-licenses/libgweather/4cc77b90af91e615a64ae04893fdffa7939db84c
...
%files
%defattr(-,root,root,-)
/usr/lib64/libgweather/Locations.bin
